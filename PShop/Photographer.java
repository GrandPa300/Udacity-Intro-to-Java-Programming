...
public class Photographer
{
    ...
    private Portfolio photo_portfolio;
    

    public Photographer(Portfolio portfolio, String photographer)
    {
        ...
        this.photo_portfolio = portfolio;
        this.photographer = photographer;
    }

   /**
    * Photographer to get assignment and add pictture to portfolio
    * @ param assignment the assignment for photographer
    */
   public void getAssignment(Assignment assignment)
   {
       String PhotoFileName = takePicture(assignment.getDescription());
       photo_portfolio.addFinishedWork(PhotoFileName, photographer);
   }
